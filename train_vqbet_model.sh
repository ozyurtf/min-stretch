...
HYDRA_FULL_ERROR=1 WANDB_MODE=disabled accelerate launch --config_file configs/accelerate/accel_cfg.yaml train.py --config-name=train_vqbet.yaml include_task=$include_task vqvae_load_dir=$RVQ_PATH batch_size=$BATCH_SIZE